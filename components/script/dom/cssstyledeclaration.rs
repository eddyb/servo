...
impl CSSStyleDeclaration {
    fn new_inherited() -> CSSStyleDeclaration {
        CSSStyleDeclaration {
            reflector_: Reflector::new()
        }
    }

    pub fn new(global: GlobalRef) -> Temporary<CSSStyleDeclaration> {
        reflect_dom_object(box CSSStyleDeclaration::new_inherited(), global,
